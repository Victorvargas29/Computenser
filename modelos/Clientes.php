  ...
  //conexion a la base de datos
   ...
   Class Clientes extends Conexion {
       ...
       //listar los usuarios
   	    ...
   	    public function registrar_cliente($cedula,$nombre,$apellido,$direccion,$telefono){
   	    ...
   	    public function editar_cliente($cedula, $nombre, $apellido,$direccion,$telefono){

             $conectar=parent::conectar();
            // parent::set_names();
             $sql="update cliente set nombre=?, apellido=?, direccion=?, telefono=? where cedula=?";
