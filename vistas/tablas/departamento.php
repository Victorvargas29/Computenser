<html>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">            
            <button id="btnNuevo" type="button" onClick="limpiar()" class="btn btn-success" data-toggle="modal" data-target="#departamentoModal">Nuevo Departamento</button>    
            </div>    
        </div>    
    </div>    
    <br>  
        ...
        <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel-body table-responsive">        
                        <table id="departamento_data" class="table table-striped table-condensed table-bordered nowrap" width="100%">
...
<!--Modal para CRUD-->
<div id="departamentoModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
