                        ...
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <form action="" target="" method="post" class="form-horizontal" id="form_lista">     
                                    <table id="presupuestos_data" class="table table-striped table-condensed table-bordered nowrap" width="100%">
                                        <thead class="text-light" style="background-color: #0e9670;">
                                            <tr>
                                                <th width="10%">Nro Presupuestos</th>
                                                <th>Cliente</th>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label class="col-form-label">Nro de Presupuestos:</label>
